...
Scenario: Person questions
	...
	And the number of questions is 5
	And the article is about Randy Pausch 
	When the user runs ask.py
	Then 4 questions from the category person will be returned
...
Scenario: Instrument questions
	...
	When the user runs ask.py
	Then 4 questions from the category instrument will be returned
...
Scenario: Language questions
	...
	When the user runs ask.py
	Then 4 questions from the category language will be returned
...
Scenario: City questions
	...
	When the user runs ask.py
	Then 4 questions from the category city will be returned
